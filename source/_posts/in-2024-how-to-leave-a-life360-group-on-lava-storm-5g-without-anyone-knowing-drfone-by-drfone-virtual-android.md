---
title: In 2024, How To Leave a Life360 Group On Lava Storm 5G Without Anyone Knowing? | Dr.fone
date: 2024-04-30T08:10:45.859Z
updated: 2024-05-01T08:10:45.859Z
tags: 
  - virtual location change
  - social app
categories:
  - android
description: This article describes How To Leave a Life360 Group On Lava Storm 5G Without Anyone Knowing?
excerpt: This article describes How To Leave a Life360 Group On Lava Storm 5G Without Anyone Knowing?
...
## How To Leave a Life360 Group On Lava Storm 5G Without Anyone Knowing?
...
- **Step 1:** Download and install Dr.Fone, then connect your Lava Storm 5G via USB cable. Launch the tool from **Toolbox** > **Virtual** **Location**. Click **Get Started** to proceed.

![dr.fone connecting smartphone to computer](https://images.wondershare.com/drfone/guide/vl-connect-ios-1.png)

- **Step 2:** Activate **Developer Mode** on your smartphone by following on-screen instructions in **Settings** > **Privacy & Security** > **Developer Mode**. Restart the Lava Storm 5G device, unlock it, and select **Turn On**. Enter your password.
...
### Method 4: Turning Off Your Lava Storm 5G
...
## How to Fake Snapchat Location on Lava Storm 5G
...
- Firstly, just install the application on your system and connect your Lava Storm 5G to it using a working cable. From the home of the Dr.Fone toolkit, launch the Virtual Location module.
- Once your Lava Storm 5G is detected, you need to agree to the terms, and click on the "Get Started" button.
...
Unlike iPhone, it is pretty easy to fake GPS on Snapchat map for Android devices. This is because there are plenty of fake GPS apps on the Play Store (which is not allowed on the App Store as of now). Though, before you use these apps, you need to make some changes on your Lava Storm 5G. Here's how you can fake Snapchat location on an Android without rooting.

1. Firstly, you need to unlock your Lava Storm 5G and visit its Settings > About Phone to tap the "Build Number" feature 7 times straight. After this, you can easily access the Developer Options on your Lava Storm 5G.

1. Great! Once it is enabled, you can go to its Settings > Developer Options and turn on the feature to mock location on the Lava Storm 5G device.
