---
title: How to Detect and Stop mSpy from Spying on Your Huawei Nova Y91 | Dr.fone
date: 2024-05-20T08:01:38.303Z
updated: 2024-05-21T08:01:38.303Z
tags: 
...
keywords: change skype location for Android,change facebook location for Huawei Nova Y91,fake Twitter location for Android,fake location for Android,change Twitter location for Huawei Nova Y91,change WhatsApp location for Huawei Nova Y91,change location for Huawei Nova Y91
...
## How to Share/Fake Location on WhatsApp for Huawei Nova Y91
...
The following video shows you how to teleport your Huawei Nova Y91 GPS location, and more tutorials can be found in the [Wondershare Video Community](https://www.wondershare.com/explore/inspiration.html).

**Here is a video for you to learn how to teleport your Huawei Nova Y91 GPS location:**
...
Using an authentic lightning cable, connect your Huawei Nova Y91 to the computer and click on the “Get Started” button.

![connect your Huawei Nova Y91 to the computer](https://images.wondershare.com/drfone/guide/virtual-location-01.png)
...
You can also open any app on your Huawei Nova Y91 and see the new location on the interface. Just go to WhatsApp now and send the fake location on WhatsApp to your friends.
...
Unfortunately, faking your WhatsApp location on iPhone is not as easy as you think. You can't just download an app that will help you to fake WhatsApp live location. Instead, you will have to use a computer program for this. There is a special tool designed by ThinkSky called iTools. It will allow the users to pick any location and trick your Huawei Nova Y91 apps into believing that you are actually at that location.
...
Step 1: Install the iTools software on your computer and connect your Huawei Nova Y91 to the computer. Once the app is installed, launch it and tap on the Virtual Location option from the home interface.

Step 2: Enter the fake location in the search box and let the software detect the location. The marker will automatically land on the map. Tap on the "Move Here" option on the screen, and your Huawei Nova Y91 location will instantly move to that particular location.
...
To get your real location back, you will have to reboot your Huawei Nova Y91. But you can only do this only 3 times for free. Also, this trick works on any iPhone running on iOS 12 and older.
...
Step 1: Open Settings > Privacy > Location Services and turn the setting on. Also, make sure that WhatsApp has access to your GPS location and install the app on your Huawei Nova Y91 from the Play Store.
