---
title: In 2024, Does find my friends work on Google Pixel 8 | Dr.fone
date: 2024-09-30T16:41:16.306Z
updated: 2024-10-05T16:19:59.994Z
tags: 
...
keywords: fake facebook location for Android,change WhatsApp location for Google Pixel 8,change location for Google Pixel 8,change skype location for Android,change facebook location for Android,change Twitter location for Android,fake location for Android,change location for Android
...
## How to Fake Snapchat Location on Google Pixel 8
...
- Firstly, just install the application on your system and connect your Google Pixel 8 to it using a working cable. From the home of the Dr.Fone toolkit, launch the Virtual Location module.
- Once your Google Pixel 8 is detected, you need to agree to the terms, and click on the "Get Started" button.
...
Unlike iPhone, it is pretty easy to fake GPS on Snapchat map for Android devices. This is because there are plenty of fake GPS apps on the Play Store (which is not allowed on the App Store as of now). Though, before you use these apps, you need to make some changes on your Google Pixel 8. Here's how you can fake Snapchat location on an Android without rooting.

1. Firstly, you need to unlock your Google Pixel 8 and visit its Settings > About Phone to tap the "Build Number" feature 7 times straight. After this, you can easily access the Developer Options on your Google Pixel 8.

1. Great! Once it is enabled, you can go to its Settings > Developer Options and turn on the feature to mock location on the Google Pixel 8 device.
