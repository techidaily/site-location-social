---
title: How to Fake Snapchat Location on Oppo A2 | Dr.fone
date: 2024-07-24T18:40:59.589Z
updated: 2024-07-25T18:40:59.589Z
tags: 
  - virtual location change
  - social app
categories:
  - android
description: This article describes How to Fake Snapchat Location on Oppo A2
excerpt: This article describes How to Fake Snapchat Location on Oppo A2
...
## How to Fake Snapchat Location on Oppo A2
...
- Firstly, just install the application on your system and connect your Oppo A2 to it using a working cable. From the home of the Dr.Fone toolkit, launch the Virtual Location module.
- Once your Oppo A2 is detected, you need to agree to the terms, and click on the "Get Started" button.
...
1. Firstly, you need to unlock your Oppo A2 and visit its Settings > About Phone to tap the "Build Number" feature 7 times straight. After this, you can easily access the Developer Options on your Oppo A2.

1. Great! Once it is enabled, you can go to its Settings > Developer Options and turn on the feature to mock location on the Oppo A2 device.
...
<!-- affiliate ads end -->
## Does Oppo A2 Have Find My Friends?
...
If your Oppo A2 or iPod using iOS via 12, the Find My Friends is already installed. On the other hand, if your Oppo A2 device is running on the iOS 8 version, then you can install this location tracker from the Apple Play Store for Free.

When you’ve signed in iCloud on your Oppo A2 device, you already have an ID on Find My Friends. You can also receive the Find My Friends notifications on your Apple watch, just need to do a little setting on the Apple Watch app on your Oppo A2.
...
3. It supports location spoofing on up to 5 iOS devices simultaneously on 1 PC/Mac. For this, you don’t need to jailbreak your Oppo A2 or face any other device complications.
...
<!-- affiliate ads end -->
## Set Your Preferred Job Location on LinkedIn App of your Oppo A2
...
LinkedIn can also be accessed from your Oppo A2 and iOS devices, and the steps to change the location on these devices are as follows.

- Step 1. Open the LinkedIn app on Your Oppo A2 and click on the profile picture and then select the View Profile option.
...
Step 2. Click on Get Started at the main software interface and then connect your Oppo A2 or your Oppo A2 to your system.

Step 3. After the Oppo A2 device is connected, a new window will open, which will show your present device location on the map.
